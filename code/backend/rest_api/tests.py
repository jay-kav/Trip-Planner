...
class TripTestCase(TestCase):
    def setUp(self):
        ...
        # Create Trip instances with members using set() method
        ...
        trip1.members.set([])  # Set members to an empty list
        ...
        trip2.members.set([user1])  # Set members to a list containing user1
        ...
        trip3.members.set([])  # Set members to an empty list
...
class TripTestCase(TestCase):
    def setUp(self):
        ...
        trip2 = Trip.objects.create(tripname="test2", startDate="2025-01-01", endDate="2025-01-02", country='Belgium', city='Brussels', hotel='ChIJaeKKqIDDw0cRPHsrdUp26hc', owner=user1)
        trip2.members.set([user2])  # Set members to a list containing user1
    ...
    def test_trips_created_correctly(self):
        ...
        self.assertEqual(trip1.members.count(), 0)  # Use members.count() to check the number of members
        ...
        self.assertEqual(trip2.members.count(), 1)  # Use members.count() to check the number of members
        ...
        self.assertEqual(trip3.members.count(), 1)  # Use members.count() to check the number of members
